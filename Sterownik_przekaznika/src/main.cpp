...
unsigned long defaultHeatTime = 5000UL;        //domyślny czas dla grzania, finalnie wpisać 600000
unsigned long defaultCooldownTime = 10000UL;   //domyślny czas dla studzenia, finalnie wpisać 1800000
